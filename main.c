...
** -f      Output is not sorted.  This option turns on the -a option. (not realize)
...
** -u      Use time of last access, instead of last modification of the file for sorting (-t) or long printing (-l). (not realize)
